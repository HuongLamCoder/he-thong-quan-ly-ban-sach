                ...
                <table class="table table-bordered text-center table-hover align-middle border-success">
                    ...
                    <?php
                        ...
                        <tr>
                            ...
                            <?php
                                if(isset($_SESSION['NQ_xem']) || isset($_SESSION['NQ_sua']) || isset($_SESSION['NQ_xoa'])){
                            ?>
                            <td>
                                <?php
                                    if(isset($_SESSION['NQ_xem'])){
                                ?>
