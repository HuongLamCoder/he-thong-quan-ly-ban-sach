                    ...
                    <div class="category-filter">
                        <div class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                ?>
                                    <li>
                                        <a class="dropdown-item" href="?page=search&category=<?=$tenTL?>&idTL=<?=$idTL?>"><?=$category['tenTL']?></a>
                                    </li>
                                <?php
                                    }
                                ?>
...
<button><i class="fa-solid fa-down"></i></button>
                    ...
                    <div class="searching-result-books">
                        ...
                        <?php 
                            ...
                            $num_per_page = 1; //total records each page
                            $curr_page = getPage();
                    ...
                    <div class="pagination">
                        ...
                        <?php           
                            ...
                            if($curr_page>1)
                                echo '<a href="?page=search'.$pageTitle.'&index='.($curr_page-1).'"><i class="fa-regular fa-chevron-left"></a>';
                            else echo '<a href="?page=search'.$pageTitle.'&index=1"><i class="fa-regular fa-chevron-left"></a>';
                            ...
                            if($curr_page<$total_pages)
                                echo '<a href="?page=search'.$pageTitle.'&index='.($curr_page+1).'"><i class="fa-regular fa-chevron-right"></a>';
                            else echo '<a href="?page=search'.$pageTitle.'&index='.$total_pages.'"><i class="fa-regular fa-chevron-right"></a>';
                        ?>
