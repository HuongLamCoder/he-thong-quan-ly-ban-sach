const changePassword = document.querySelector("#info_changePassword");
...
const validateInfoForm = () => {
    ...
    let infoFormIsValid = fullnameIsValid &&
                                        emailIsValid &&
                                        phoneNumberIsValid;
    if(changePassword.checked) {
        ...
        let passwordFormIsValid = currentPasswordIsValid &&
                                                     newPasswordIsValid &&
                                                     confirmNewPasswordIsValid;
        let fullFormIsValid = infoFormIsValid &&
                                          passwordFormIsValid;
        return fullFormIsValid; 
    } else {
...
$(document).ready(function () {
    $("#info_form").submit(function (e) {
        ...
        if (validateInfoForm()) {
            ...
            // var isChangePasswordChecked = $('#info_changePassword').is(':checked');
            // formData.append('changePasswordChecked', isChangePasswordChecked);
            $.ajax({
