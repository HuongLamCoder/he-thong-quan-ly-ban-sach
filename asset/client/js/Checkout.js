$(document).ready(function () {
    ...
    // Checkout Payment submit form event handler
    // $('#checkout-submit-btn').on('click', function () {
    //     let paymentMethod = $('#payment-method-form input:checked').prop('id');
    //     $.ajax({
    //         url: 'controller/client/CheckoutController.php',
    //         type: 'get',
    //         data: {
    ...
    //                 // window.location.href = `index.php?page=checkout&step=3`;
    //             } else {
    //                 toast({
    //                     title: 'Thất bại',
    //                     message: response.message,
