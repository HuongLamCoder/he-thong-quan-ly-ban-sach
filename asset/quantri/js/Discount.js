...
function formValidateDiscount() {
    ...
    if(phantram < 0 || phantram>100 || isNaN(phantram)) {   //nếu tên rỗng
        discount_percent_msg.html("Phần trăm không hợp lệ");
        return false;
    }
    ...
    if(start <= curr_date){
        ...
        discount_date_end_msg.html( "Ngày bắt đầu phải lớn hơn ngày hiện tại!");
        return false;
    }

    if(ngaybatdau >= ngayketthuc){
        discount_date_start_msg.html("Ngày kết thúc phải lớn hơn bắt đầu!");
