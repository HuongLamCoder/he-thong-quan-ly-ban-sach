...
require_once "../inc/tfpdf/tfpdf.php";
...
class PDF extends tFPDF {
    ...
    function Header() {
        ...
        //Container for image
        $this->Cell(40, 10, "", 0, 0);
        $this->Image('../../asset/img/vinabook-logo.png', 10, 11.5, 35, 5);
        //Header title
...
if(isset($_GET['month'])) {
    $date = $_GET['month'];
    $dateStart = $date . "-01";
    $dateEnd = $date . "-" . lastDayOfMonth($date);
    $weeks = getWeeks($date);
}
        ...
        case 'income':
            ...
            //Table
                ...
                for($i = 1; $i <= sizeof($weeks); $i++) {
                    ...
                    /* orderProductCount */
                    $orderProductCount = getOrderProductCount($dateWeekStart, $dateWeekEnd);
        ...
        case "cost":
            ...
            //Table
                ...
                for($i = 1; $i <= sizeof($weeks); $i++) {
                    ...
                    /* grnQty */
                    $grnQty = getGRNProductCount($dateWeekStart, $dateWeekEnd);
                    /* grnQty */
    ...
    switch ($opt) {
        case "income":
            ...
            for ($i = 1; $i <= sizeof($months); $i++) {
                ...
                /* orderProductCount */
                $orderProductCount = getOrderProductCount($dateMonthStart, $dateMonthEnd);
                /* orderProductCount */
        ...
        case "cost":
            ...
            for ($i = 1; $i <= sizeof($months); $i++) {
                ...
                /* grnQty */
                $grnQty = getGRNProductCount($dateMonthStart, $dateMonthEnd);
                /* grnQty */
